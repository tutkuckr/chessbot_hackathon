...
//	moves[count++] = make_move(12, 28, NO_TYPE);
//	moves[count++] = make_move(52, 36, NO_TYPE);
//	moves[count++] = make_move(57, 53, NO_TYPE);
//	moves[count++] = make_move(58, 42, NO_TYPE);
//	moves[count++] = make_move(60, 53, NO_TYPE);
